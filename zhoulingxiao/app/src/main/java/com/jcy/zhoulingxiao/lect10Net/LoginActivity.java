package com.jcy.zhoulingxiao.lect10Net;
...
import com.jcy.zhoulingxiao.R;
import com.jcy.zhoulingxiao.lect10Net.list.NetListActivity;
        ...
        cmitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(nameVal)) {
                    Toast.makeText(com.jcy.zhoulingxiao.lect10Net.LoginActivity.this, "请输入姓名", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(pwdVal)) {
                    Toast.makeText(com.jcy.zhoulingxiao.lect10Net.LoginActivity.this, "请输入密码", Toast.LENGTH_SHORT).show();
                    return;

                }else{
                    Toast.makeText(com.jcy.zhoulingxiao.lect10Net.LoginActivity.this, "登陆成功", Toast.LENGTH_SHORT).show();
                }
                Intent intent = new Intent(com.jcy.zhoulingxiao.lect10Net.LoginActivity.this, NetListActivity.class);
